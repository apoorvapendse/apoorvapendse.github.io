...
1. Clean state
	1. A stack with a clean state belongs to one of the following types:
		1. **Pure run**
			...
			3. ![[Pasted image 20260203175033.png]]
		2. **Same set**
			...
			3. Here are some examples for valid same set stacks:![[Pasted image 20260203174957.png]]
			4. An invalid same set case because of duplicates: ![[Pasted image 20260203175011.png]]
		3. **Alternate run/ RED-BLACK run**
			...
			2. ![[Pasted image 20260203175023.png]]